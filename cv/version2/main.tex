...
\begin{document}
    ...
    \vspace{5 pt - 0.3 cm}
        ...
        \vspace{0.15 cm}
			...
			With such aspiring hopes, I am preparing myself for the furture enterprise by studying physics, CS, chemistry, and founding Yetin LTD.
        \end{onecolentry}
        % \vspace{0.2 cm}
    ...
    \section{Education}
        ...
        \begin{twocolentry}{
            ...
            \textbf{University of Edinburgh}, MMath (Hons). Graduating in Sept 2026.
		\end{twocolentry}
