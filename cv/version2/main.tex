...
\begin{document}
    ...
    \begin{header}
        ...
        \normalsize
        \kern 5.0 pt%
        \mbox{\hrefWithoutArrow{mailto:s2162783@ed.ac.uk}{s2162783@ed.ac.uk}}%
        \kern 5.0 pt%
        \AND%
        \kern 5.0 pt%
        \mbox{\hrefWithoutArrow{tel:+44 7769466855}{07769466855}}%
        \kern 5.0 pt%
        \AND%
        \kern 5.0 pt%
        ...
        % \AND%
        % \kern 5.0 pt%
        \mbox{\hrefWithoutArrow{https://github.com/harryhanYuhao}{github.com/harryhanYuhao}}%
    \end{header}
