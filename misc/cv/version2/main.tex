   ...
   %      \end{onecolentry}
    ...
    \section{Education}
        \begin{twocolentry}{
            ...
            \textbf{University of Oxford}, DPhil in Computer Science.
        \vspace{0.10 cm}
        \begin{onecolentry}
		\begin{highlights}
			\item I will study quantum computation under the supervision of Prof Sergii Strelchuk and Dr Sathya Subramanian.
            \end{highlights}
        \end{onecolentry}
	...
	\begin{enumerate}
		...
		\item (Submitted to ICRL 2026) \textit{InvCLIP: Invariant Vision–Language Alignment via Neural Collapse}
	...
	\section{Awards}
	\begin{enumerate}
		\item Professor Sheridan's Simons Investigator Award for research in algebraic geometry, 2000£, 2024.
	\end{enumerate}
