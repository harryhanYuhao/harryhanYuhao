...
\begin{document}
    ...
    \vspace{5 pt - 0.3 cm}
        ...
        \begin{onecolentry}
			...
			My major interest lies in pure mathematics, especially algebraic geometry and algebraic topology. I am also a proficient and self-taught programmer. I believe the interaction between math and CS will spark the next great enlightenment in our generation.
        \end{onecolentry}
        % \vspace{0.2 cm}
		...
		\begin{twocolentry}{
	        ...
	        \begin{onecolentry}
	            \begin{highlights}
					...
					\item \textit{Professor Sheridan's Simons Investigator Award}, 2000£
	            \end{highlights}
	        \end{onecolentry}
    ...
    \section{Coding Projects}
		...
		\href{https://github.com/harryhanYuhao/tex-helper}{\underline{\textbf{Tex Helper}}}
		\end{twocolentry}
        \vspace{0.10 cm}
        \begin{onecolentry}
			Command line tool in Rust to help you write LaTeX faster.
	...
	\section{Programming Technologies}
        \begin{onecolentry}
			Linux \textbullet{} C \textbullet{} Rust \textbullet{} C++ \textbullet{} Bash \textbullet{} \LaTeX \textbullet Git \textbullet Vim \textbullet Typescript \textbullet React \textbullet OpenGL \textbullet Lua \textbullet{} Julia \textbullet Python \textbullet{} MATLAB \textbullet{} Unity \textbullet AWS
