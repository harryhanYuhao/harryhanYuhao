...
\begin{document}
    ...
    \vspace{5 pt - 0.3 cm}
        ...
        \begin{onecolentry}
			...
			My major interest lies in pure mathematics, especially algebraic geometry and algebraic topology. I am also a proficient and self-taught programmer. I believe the interaction between maths and CS will spark the next great enlightenment in our generation.
        \end{onecolentry}
        % \vspace{0.2 cm}
	...
	\begin{enumerate}
		\item \textit{Preprint} A Brain-Inspired Continual Learning System for Cross-User and Cross-Device Biosignals. Zhikang Chen, et al.
	\end{enumerate}
    ...
    \section{Work Experience}
		...
		\textbf{Self Empolyed}, English Tutor
		\end{twocolentry}
        \vspace{0.10 cm}
		%%%% EXPERIENCE YETIN
        \begin{twocolentry}{
